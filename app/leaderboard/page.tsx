...
import { Search, Users, MessageSquare, ArrowLeft, Trophy, Medal, Award, Crown, Star, TrendingUp } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">Recognize our most valuable community contributors</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {filteredUsers.slice(0, 3).map((user, index) => (
            <Card key={user.id} className={`relative overflow-hidden border-0 ${getRankBadgeColor(user.rank)} p-1`}>
              <div className="bg-white rounded-lg p-6 h-full">
                <div className="text-center">
                  ...
                  <Badge className={`${getRankBadgeColor(user.rank)} text-white mb-3`}>
                    {user.badge}
                  </Badge>
          ...
          <CardContent>
            <div className="space-y-4">
              {filteredUsers.map((user) => (
                <div key={user.id} className="flex items-center space-x-4 p-4 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex items-center space-x-6 text-sm text-gray-500">
                    <div className="text-center">
                      <div className="font-semibold text-gray-900">{user.reputation.toLocaleString()}</div>
                    ...
                    <div className="text-center">
                      <div className="font-semibold text-gray-900">{user.likes}</div>

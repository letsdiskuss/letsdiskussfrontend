    ...
    <main className="min-h-screen bg-gray-100 py-8 px-4">
      <div className="max-w-5xl mx-auto bg-white p-8 rounded shadow">
        ...
        <p className="text-gray-700 mb-4">
          ...
          devices or anything else. No information is shared with anyone except
          as described in the privacy policy.
        </p>
        <p className="text-gray-700 mb-4">
          We have designed this privacy policy page not to apply to information
          collected by other means or from other sources. Not to mention
          capitalized terms that are most defined in this privacy policy that
          have meaning given them in our Terms of Services.
        </p>
        ...
        <p className="text-gray-700 mb-4">
          We use information (collected by us) to analyze how the Service is
          used along with diagnose service or technical problems. In addition,
          also analyze how services are used to maintain security, personalize
          content, monitor amassed metrics that may include total number of
          visitors, traffic and demographic patterns, remember information to
          help you efficiently right to use of your account and track User
          Content and users as required to comply with the Digital Millennium
        ...
        <p className="text-gray-700 mb-4">
          ...
          policy to use these automated technologies to collect and analyze
          certain types of information that may include: Information related to
          the devices or browsers you use to access or interact with the
          Service, such as: IP addresses, geo-location information Unique device
          identifiers and other information about your mobile phone or other
          mobile device(s) Browser types, browser language, and unique numbers
          or codes in cookies Information related to the ways in which you
          interact with the Service like referring and exit pages and URLs,
          platform type, the number of clicks, domain names, landing pages,
        ...
        <h2 className="text-xl font-semibold text-black mt-6 mb-2">
          Information on Different Points
        </h2>
        <p className="text-gray-700 mb-4">
          We may collect different types of information about your location,
          including general information like IP address, zip code and more
          specific information like GPS-based functionality on mobile devices
          used to access the Service or may use that information to customize
          the Service with location-based information and features. You can
          ...
          in every time you come back to the website. Cookies also allow
          ...
          may also stay in system until they expire or overwritten with newer
          cookies or you manually remove them. Not to Accept Cookies is a
          features often configured by the browsers to prevent you from having
          access to some site functions or features. At the same time asexact
          names of the cookies and similar technologies that we use may change
          from time to time as we get better and update our services that
          generally fall into the different forms that may include, but not
          limited to:
        </p>
        <h2 className="text-xl font-semibold text-black mt-6 mb-2">
        ...
        <h2 className="text-xl font-semibold text-black mt-6 mb-2">
          Product Features and Setting Cookies
        </h2>
        <p className="text-gray-700 mb-4">
        ...
        <p className="text-gray-700 mb-4">
          – In convinced situations, we may use Adobe Flash Player to deliver
          special content and to improve your user experience. Flash cookies are
          taken into use to endow you with functions of remembering your
          settings and preferences. Analytics and Advertising for Third Party We
          (may) allow third parties to help us collect and analyze information
          about your use of the service and to generate aggregate site usage
          ...
          of ads on third-party sites based on this. We are free to share your
          information with third party service providers for the purpose of
          providing better service to you like payment processors, email service
          providers and providers of technical infrastructure as well as
        ...
        <h2 className="text-xl font-semibold text-black mt-6 mb-2">
          Rights of Selling/Purchasing Business Offerings and Assets
        </h2>
        <p className="text-gray-700 mb-4">
          Our team is developing and contributing in growth of business, we may
          buy/sell assets or business offerings. In such a case, Email
          addresses, visitor information and customers are among the transferred
        ...
        <p className="text-gray-700 mb-4">
          Information related to you may be disclosed, in case we need to do
          this by law or we believe in good faith that it is vital to respond to
          claims asserted against us or to comply with legal process. We also
        ...
        <p className="text-gray-700 mb-4">
          ...
          submit information through the services. in which case, we may not be
          able to endow with certain services to you. Updating or correcting
          your account information and email preferences at any time by logging
          in to your account is in privacy policy. You may also delete your
          account, in case you chose to.
        </p>
        <h2 className="text-xl font-semibold text-black mt-6 mb-2">
          Privacy of Children
        </h2>
        ...
        <p className="text-gray-700 mb-4">
          ...
          effective, when they are posted on this page. For nay change or any
          kind of information, you can mail us. privacy policy
        </p>
      </div>
    </main>
  );

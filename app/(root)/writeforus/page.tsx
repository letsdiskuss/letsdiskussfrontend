    ...
    <div className="">
        ...
        <div className="max-w-7xl w-full grid md:grid-cols-2 gap-20">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-gray-700 mb-6">
              Do you want to become more visible online, become an authority in your field, and increase website traffic?
              There's nowhere else to look! Let's Diskuss provides excellent guest post services that are intended to improve
              your brand and increase your internet presence.
            </p>
      ...
      <div className="bg-gray-100 py-16 flex flex-col items-center px-4">
        ...
        <p className="text-center max-w-2xl text-gray-600 mb-12">
          One effective digital marketing tactic is guest blogging, which is creating and uploading content
          on other websites related to your topic or sector. By adding worthwhile material to respectable
          websites, you can:
        </p>
...
<div className="bg-white py-16 px-4 flex flex-col items-center">
  ...
  <div className="max-w-4xl text-center mb-12">
    ...
    <p className="text-gray-700">
      Here at Let's Diskuss, we recognize the value of thoughtful guest writing in the current online environment.
      Our guest posting services are intended to make you stand out from the competition and accomplish your marketing objectives.
  ...
  <div className="max-w-7xl w-full grid md:grid-cols-2 gap-10 items-center">
    ...
    <div className="space-y-6 text-black text-sm">
      <p>
        <span className="font-semibold">High-quality:</span> This content is essential when it comes to guest posting,
        in our opinion. Our skilled writing staff will produce thoroughly researched, interesting, and educational
        pieces that fit the tone and style of the intended publication and appeal to your target readership.
      </p>
      <p>
        <span className="font-semibold">Relevant websites:</span> We have forged connections with a wide range of
        respectable websites in different markets and specializations. For your guest articles, we'll choose the most
        authoritative and relevant websites, regardless of the audience or niche you're trying to reach.
      </p>
      <p>
        <span className="font-semibold">White-Hat Practices:</span> We follow stringent white-hat procedures to
        guarantee that your guest articles are morally sound, environmentally friendly, and search engine compatible.
        Our strategy is centered on establishing sincere connections with website owners and adding value for their viewers.
      </p>
      <p>
        <span className="font-semibold">Transparent Process:</span> We think that communication and transparency should
        be practiced at every stage. Throughout the guest posting process, we keep you updated and involved with everything
        from subject brainstorming and content development to publishing and performance monitoring.
      </p>
    </div>
